...
const Navbar = () => {
  ...
  return (
    <nav className="fixed mx-auto top-0 left-0 right-0 z-10 bg-[#1e2030] bg-opacity-100">
        ...
        <div className="block mobile-menu md:hidden">
          {!navbarOpen ? (
            <button
              ...
              className="flex items-center px-3 py-2 rounded text-[#7dc4e4] hover:text-white hover:border-white"
            >
              <ArrowDownLeft className="w-5 h-5"></ArrowDownLeft>
            </button>
          ) : (
            <button
